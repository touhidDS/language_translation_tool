...
def resolve_source_language(text: str, source: str) -> str:
    ...
    library isn't installed or detection fails. Always returns a plain
    2-letter code (langdetect can return region-qualified codes like
    'zh-cn', which MyMemory rejects)."""
    if source != "auto":
        return source
